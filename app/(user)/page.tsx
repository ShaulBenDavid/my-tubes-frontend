...
const Home = () => {
  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center">
      {!username && (
        <button
          className="mb-4 mb-8 rounded border bg-white px-4 py-2 font-bold  text-gray-800  shadow  focus:outline-none"
      ...
      {username ? (
        <div className="text-center">
          ...
          <button
            ...
            className="mt-2 rounded bg-red-400 px-4 py-2 font-semibold text-white hover:bg-red-200"
          >
            Logout
          </button>
        </div>
